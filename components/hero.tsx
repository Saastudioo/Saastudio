        ...
        <div className="pt-32 pb-16 md:pt-52 md:pb-32">
          ...
          <div className="max-w-3xl mx-auto text-center">
            <div className="mb-6" data-aos="fade-down">
              <div className="inline-flex relative before:absolute before:inset-0 before:bg-gray-500 before:blur-md">
                <a
                  className="btn-sm py-0.5 text-slate-300 hover:text-white transition duration-150 ease-in-out group [background:linear-gradient(theme(colors.gray.500),_theme(colors.gray.500))_padding-box,_linear-gradient(theme(colors.gray.500),_theme(colors.gray.200)_75%,_theme(colors.transparent)_100%)_border-box] relative before:absolute before:inset-0 before:bg-slate-800/50 before:rounded-full before:pointer-events-none shadow"
                  href="https://calendly.com/saastudio/30min"
                  target="_blank"
                >
                  <span className="relative inline-flex items-center">
                    Book A Call Here!{" "}
                    <span className="tracking-normal text-gray-500 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">
                      -&gt;
                    </span>
                  </span>
                </a>
            ...
            <p
              ...
              data-aos-delay="200"
            >
              From websites to marketing, we've got you covered. Let's simplify
