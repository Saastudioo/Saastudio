            ...
            <div className="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:space-x-8 lg:space-x-16 xl:space-x-20 space-y-8 space-y-reverse md:space-y-0">
              ...
              >
                ...
                <p className="text-lg text-slate-400 mb-8">
                  We bring a wealth of knowledge and skills to the table,
                  ensuring top-notch solutions tailored to your needs.
                </p>
                <div className="mt-8 max-w-xs max-md:mx-auto space-y-2">
                  <button
                    className={`flex items-center text-sm font-medium text-slate-50 rounded border bg-slate-800/25 w-full px-3 py-2 transition duration-150 ease-in-out hover:opacity-100 ${
                      tab !== 1
                        ...
                        : "border-slate-700 shadow shadow-slate-500/25"
                    }`}
                    onClick={() => setTab(1)}
                  >
                    <svg
                  ...
                  <button
                    className={`flex items-center text-sm font-medium text-slate-50 rounded border bg-slate-800/25 w-full px-3 py-2 transition duration-150 ease-in-out hover:opacity-100 ${
                      tab !== 2
                        ? "border-slate-700 opacity-50"
                        : "border-slate-700 shadow shadow-purple-500/25"
                    }`}
                    onClick={() => setTab(2)}
                  >
                    <svg
                      ...
                      >
                        <defs>
                          <linearGradient
                            ...
                            y2="0%"
                          >
                            <stop offset="0%" stopColor="#fcfcf2" />
                            <stop offset="76.382%" stopColor="#fcfcf2" />
                            <stop offset="100%" stopColor="#fcfcf2" />
                          </linearGradient>
                        </defs>
                        <g fillRule="evenodd">
                          <path
